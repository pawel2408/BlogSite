...
class SettingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        'site_logo', 'site_logo_light', 'site_extra', 'post_ads', 'page_ads', 'between_ads', 'fb_page_token','fb_publishing', 'fb_theme', 'fb_ads_code', 'amp_ad_server', 'amp_adscode', 'footer', 'site_analytic', 'theme', 'cookie_option', 'cookie_title', 'cookie_body']);
